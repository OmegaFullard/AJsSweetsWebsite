<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/MasterPage.Master" CodeFile="Privacy.aspx.cs" Inherits="Privacy" %>
    ...
    <div class="container my-5">
        <div class="row">
            <div class="col-lg-12">
                ...
                <p class="text-muted">Last Updated: February 10, 2026</p>
                <hr />

                <section class="mb-5">
                    <h2 class="h3 mb-3">1. Introduction</h2>
                    <p>
                        Welcome to AJ's Sweets ("we," "our," or "us"). We are committed to protecting your personal 
                ...
                <section class="mb-5">
                    ...
                    <h3 class="h5 mb-2 mt-4">Automatically Collected Information</h3>
                ...
                <section class="mb-5">
                    <h2 class="h3 mb-3">4. Cookies and Tracking Technologies</h2>
                    <p>
                    ...
                    <ul>
                        ...
                        <li><strong>Marketing Cookies:</strong> Track your browsing habits to show you relevant advertisements</li>
                    </ul>
                    <p>
                ...
                <section class="mb-5">
                    <h2 class="h3 mb-3">5. How We Share Your Information</h2>
                ...
                <section class="mb-5">
                    <h2 class="h3 mb-3">8. Your Privacy Rights</h2>
                ...
                <section class="mb-5">
                    <h2 class="h3 mb-3">9. Third-Party Websites</h2>
                    <p>
                ...
                <section class="mb-5">
                    <h2 class="h3 mb-3">11. Changes to This Privacy Policy</h2>
                    <p>
                ...
                <section class="mb-5">
                    ...
                    <address>
                        <strong>AJ's Sweets</strong><br />
                        Email: <a href="mailto:privacy@ajsweets.com">privacy@ajsweets.com</a><br />
                        Phone: <a href="tel:+1404567890">+1 (404) 567-890</a><br />
